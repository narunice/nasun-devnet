...
### 1.2 현재 노드 아키텍처 (3-Node m6i, V7)

| Node | IP | Role | Services | Instance |
|------|-----|------|----------|----------|
| Node 1 | 3.38.127.23 | Validator + Faucet | nasun-validator, nasun-faucet, nginx | m6i.large (8GB) |
| Node 2 | 3.38.76.85 | Validator + zkLogin Prover | nasun-validator, docker (zkprover) | m6i.large (8GB) |
| Node 3 | 54.180.61.196 | Fullnode + Indexer + Explorer | nasun-fullnode, sui-indexer, postgresql, explorer-api, baram-aer-api, nginx | m6i.2xlarge (32GB) |

> **참고**: 2026-02-21 3-node 마이그레이션, 2026-03-01 Node 3 m6i.2xlarge 업그레이드
> HTTPS 엔드포인트: `rpc.devnet.nasun.io` (Node 3 nginx), `faucet.devnet.nasun.io` (Node 1 nginx)
